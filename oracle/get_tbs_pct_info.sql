...
from (
SELECT a.tablespace_name tablespacename, round(a.current_size - c.free + r.recyclebin_size, 1) "USED_SIZE", round(((a.current_size - c.free + r.recyclebin_size)*100)/a.max_size, 1) "USED_PCT"
FROM
...
union all
SELECT a.tablespace_name tablespacename, round(a.current_size - c.free, 1) "USED_SIZE", round(((a.current_size - c.free)*100)/a.max_size, 1) "USED_PCT"
FROM
...
union all
select a.tablespace_name tablespacename, round(b.used_size, 1) as "USED_SIZE", round(b.used_size/a.max_size*100, 1) as "USED_PCT" from 
